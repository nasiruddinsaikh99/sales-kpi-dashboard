<aside class="sidebar-expanded bg-white dark:bg-gray-900 border-r border-gray-200 dark:border-gray-800 flex flex-col fixed h-full transition-all duration-300 transform -translate-x-full md:translate-x-0 z-30" id="sidebar">
    ...
    <nav class="flex-1 px-2 py-4 space-y-1 overflow-y-auto">
        ...
        <a href="/sales-kpi-dashboard/admin/upload" class="nav-item flex items-center gap-3 px-3 py-2.5 rounded-lg transition <?= strpos($_SERVER['REQUEST_URI'], '/admin/upload') !== false && strpos($_SERVER['REQUEST_URI'], '/admin/rankings') === false ? 'bg-indigo-50 dark:bg-gray-800 text-indigo-600 dark:text-white' : 'text-gray-600 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-800' ?>" title="Upload Data">
        ...
        <a href="/sales-kpi-dashboard/admin/rankings" class="nav-item flex items-center gap-3 px-3 py-2.5 rounded-lg transition <?= strpos($_SERVER['REQUEST_URI'], '/admin/rankings') !== false || strpos($_SERVER['REQUEST_URI'], '/admin/leaderboard') !== false ? 'bg-indigo-50 dark:bg-gray-800 text-indigo-600 dark:text-white' : 'text-gray-600 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-800' ?>" title="Rankings">
            <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"></path></svg>
            <span class="sidebar-text whitespace-nowrap">Rankings</span>
        </a>
